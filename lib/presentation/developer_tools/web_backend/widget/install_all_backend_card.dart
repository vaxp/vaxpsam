...
import 'package:vaxpsam/data/web_backend_data.dart';
...
class InstallAllBackendCard extends ConsumerWidget {
  const InstallAllBackendCard({super.key});

  void _installAllTools(BuildContext context, system) {
    final tools = WebBackendData.kAllToolPackages; // استخدام قائمة الحزم
